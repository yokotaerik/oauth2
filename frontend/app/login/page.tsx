          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <motion.div variants={itemVariants} className="space-y-2">
                ...
                >
                  <Input
                    ...
                    className="h-12 pl-4 pr-4 border-2 transition-all duration-200 focus:border-blue-500 focus:ring-blue-500"
                    required
                  />
                  <motion.span
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                ...
                >
                  <Input
                    ...
                    onBlur={() => setActiveInput(null)}
                    className="h-12 pl-4 pr-12 border-2 transition-all duration-200 focus:border-blue-500 focus:ring-blue-500"
                    required
                  />
                  <Button
                    type="button"
              ...
              <motion.div variants={itemVariants} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Button
                  type="submit"
                  className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium transition-all duration-300 ease-in-out transform"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <motion.div
                    ...
                    <motion.span
                      ...
                      whileHover={{
                        scale: 1.05,
                        transition: { duration: 0.2, yoyo: Number.POSITIVE_INFINITY },
                      }}
                    >
                      Entrar
                    </motion.span>
